...
- 📊 [Portfolio Risk Balancing](https://github.com/parsabuilds/portfolio-risk-balancing) - Five AI decision strategies (rule-based, fuzzy, mean-variance, CSP+search, genetic) compared head-to-head on portfolio allocation across a 10-asset universe including Bitcoin [Report](https://github.com/parsabuilds/portfolio-risk-balancing/blob/main/report/Report_ParsaRajabi.pdf)
- ⚙️ [YOLOv8 CPU Scheduling Simulator](https://github.com/parsabuilds/yolov8-cpu-scheduling-simulator) - Compares FCFS, SJF, RR, EDF, and Rate-Monotonic on a multi-stream YOLOv8 inference workload [Report](https://github.com/parsabuilds/yolov8-cpu-scheduling-simulator/blob/main/report/Report_ParsaRajabi.pdf) 
