...
CS grad → Georgia Tech MSCS. Doing my best at building things that people might find useful. 3 x Hackathon winner.
...
- 🛑 [GTSRB Traffic Sign Classification](https://github.com/parsabuilds/gtsrb-traffic-sign-classification) - ResNet50 transfer learning classifying German traffic signs into shape categories with 99.83% test accuracy [See Report](https://github.com/parsabuilds/gtsrb-traffic-sign-classification/blob/main/report/Report_ParsaRajabi.pdf)
